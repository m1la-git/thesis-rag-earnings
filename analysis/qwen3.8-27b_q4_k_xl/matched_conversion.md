...
Model: `qwen3.8-27b@q4_k_xl`. Source: `results/tables/qwen3.8-27b_q4_k_xl/generation_outcomes.csv`.
...
|---|--:|--:|--:|--:|--:|--:|
| text_only | 38 | 23 | 14 | 1 | 0 | **60.5%** |
| enriched | 38 | 30 | 7 | 0 | 1 | **78.9%** |
...
|---|--:|--:|--:|--:|--:|--:|
| newly entered (enriched) | 63 | 49 | 12 | 2 | 0 | **77.8%** |
...
|---|--:|--:|--:|
| factual | 100.0% (n=14) | 100.0% (n=14) | 97.6% (n=41) |
| thematic | 88.9% (n=9) | 100.0% (n=9) | 85.7% (n=7) |
| comparative | 6.7% (n=15) | 46.7% (n=15) | 20.0% (n=15) |
...
**The 7 discordant observations come from only 3 distinct questions:**

| question | category | discordant in | of its intersection pairs | winner | condition pairs |
|---|---|--:|--:|---|---|
| `ref_comp_06` | comparative | 4 | 5 | enriched | chunk200_bm25, chunk200_hybrid, chunk500_dense, chunk500_bm25 |
| `ref_comp_11` | comparative | 2 | 2 | enriched | chunk200_hybrid, chunk500_dense |
| `ref_them_02` | thematic | 1 | 4 | enriched | chunk500_bm25 |
...
|---|--:|--:|--:|--:|--:|--:|
| pooled | 38 | 0 | 7 | 31 | 7 | 0.0156 |
| factual | 14 | 0 | 0 | 14 | 0 | n/a (no discordant pairs) |
| thematic | 9 | 0 | 1 | 8 | 1 | 1.0000 |
| comparative | 15 | 0 | 6 | 9 | 6 | 0.0312 |
...
| thematic | 3 | 0 | 1 | 2 | 1 | 1.0000 |
| comparative | 4 | 0 | 2 | 2 | 2 | 0.5000 |

### 5.3 What the two tests jointly support

The observation-level test gives p=0.0156 pooled; the question-level test gives
p=0.5000. **The question-level test does not reach significance at any conventional
...
2 discordant questions cannot support one.

**What does stand, independent of any test, as a descriptive fact:**

> **b = 0 everywhere.** Across all 38 matched observations and all 13 distinct questions, in every category, **not one item was correct under `text_only` and incorrect under `metadata_enriched`.** Every discordant observation runs in the same direction. This is a property of the observed data, not an inference from a test, and it does not depend on the independence assumption that makes 5.1 unsafe.
