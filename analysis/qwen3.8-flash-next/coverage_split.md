...
Model: `qwen3.8-flash-next`. Population: every Case C observation across all 12 conditions (**n=147**).
...
| factual | enriched | 100% (55/55) | — | — |
| thematic | text_only | — | — | 100% (13/13) |
| thematic | enriched | — | — | 88% (14/16) |
| comparative | text_only | — | — | 11% (2/18) |
| comparative | enriched | — | 100% (2/2) ⚠ | 43% (12/28) |
...
| comparative | 100% (2/2) ⚠ | 30% (14/46) | +70% |
...
|---|--:|--:|--:|--:|--:|
| text_only | 18 | 16 | 2 | 0 | 0 |
| enriched | 28 | 15 | 12 | 1 | 0 |
| both pooled | 46 | 31 | 14 | 1 | 0 |
...
| enriched | 16 | 2 | 14 | 0 | 0 |
| both pooled | 29 | 2 | 27 | 0 | 0 |
