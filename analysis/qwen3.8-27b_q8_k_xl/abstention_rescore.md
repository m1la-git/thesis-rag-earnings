...
|---|---|---|---|--:|
| pooled | text_only | 67.4% (31/46) | 100.0% (46/46) | +32.6pp |
| pooled | enriched | 77.2% (78/101) | 95.0% (96/101) | +17.8pp |
| pooled | both arms | 74.1% (109/147) | 96.6% (142/147) | +22.4pp |
| factual | text_only | 100.0% (15/15) | 100.0% (15/15) | — |
| factual | enriched | 98.2% (54/55) | 98.2% (54/55) | — |
| factual | both arms | 98.6% (69/70) | 98.6% (69/70) | — |
| thematic | text_only | 100.0% (13/13) | 100.0% (13/13) | — |
| thematic | enriched | 87.5% (14/16) | 87.5% (14/16) | — |
| thematic | both arms | 93.1% (27/29) | 93.1% (27/29) | — |
| comparative | text_only | 16.7% (3/18) | 100.0% (18/18) | +83.3pp |
| comparative | enriched | 33.3% (10/30) | 93.3% (28/30) | +60.0pp |
| comparative | both arms | 27.1% (13/48) | 95.8% (46/48) | +68.8pp |
...
| scope | arm | primary | alternative | delta |
|---|---|---|---|--:|
| pooled | text_only | 63.2% (24/38) | 100.0% (38/38) | +36.8pp |
| pooled | enriched | 76.3% (29/38) | 97.4% (37/38) | +21.1pp |
| pooled | both arms | 69.7% (53/76) | 98.7% (75/76) | +28.9pp |
| factual | text_only | 100.0% (14/14) | 100.0% (14/14) | — |
| factual | enriched | 100.0% (14/14) | 100.0% (14/14) | — |
| thematic | text_only | 100.0% (9/9) | 100.0% (9/9) | — |
| thematic | enriched | 88.9% (8/9) | 88.9% (8/9) | — |
| comparative | text_only | 6.7% (1/15) | 100.0% (15/15) | +93.3pp |
| comparative | enriched | 46.7% (7/15) | 100.0% (15/15) | +53.3pp |
...
> **On the 38-item intersection the two arms converge at 100.0% and 97.4% —
> effectively identical.** Under the primary taxonomy the same population reads
> 63.2% for `text_only` against 76.3% for `metadata_enriched`, a gap of
> 13.2 percentage points. **That gap largely disappears once correct
...
**33 of 147** Case C observations change from a failure to a success under the alternative rule — every one of them a comparative partial-coverage abstention. **22** of them fall inside the 38-item intersection.
...
| chunk500_hybrid | ref_comp_06 | 0.50 | yes |
| chunk500_hybrid | ref_comp_11 | 0.50 | no |
| chunk500_hybrid_enriched | ref_comp_02 | 0.50 | yes |
| chunk500_hybrid_enriched | ref_comp_08 | 0.50 | yes |
| chunk500_hybrid_enriched | ref_comp_09 | 0.50 | no |

The 33 changed observations come from **9 distinct questions** (`ref_comp_01` x1, `ref_comp_02` x9, `ref_comp_04` x1, `ref_comp_06` x5, `ref_comp_07` x1, `ref_comp_08` x9, `ref_comp_09` x1, `ref_comp_11` x4, `ref_comp_12` x2), the largest single contributor being `ref_comp_08` with 9 of the 33. This is the same dependency structure that made the observation-level McNemar in `analysis/qwen3.8-27b_q4_k_xl/matched_conversion.md` anti-conservative: a handful of questions repeated across condition pairs, not independent trials. **Every figure in this document, including section 2.1, inherits it.** Read these as observation counts; no significance claim is made from them in either direction.
