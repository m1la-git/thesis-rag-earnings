...
Model: `qwen3.8-27b@q8_k_xl`. Population: Case C `answered_grounded_correct`.
...
| arm | n | flagged | % |
|---|--:|--:|--:|
| text_only (published post-fix) | 31 | 10 | 32% |
| **metadata_enriched** | **78** | **10** | **13%** |
...
|---|--:|--:|--:|--:|
| dense | 2/8 | 25% | 5/31 | 16% |
| bm25 | 4/11 | 36% | 2/16 | 12% |
