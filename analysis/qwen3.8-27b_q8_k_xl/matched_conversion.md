...
Model: `qwen3.8-27b@q8_k_xl`. Source: `results/tables/qwen3.8-27b_q8_k_xl/generation_outcomes.csv`.
...
|---|--:|--:|--:|--:|--:|--:|
| text_only | 38 | 24 | 14 | 0 | 0 | **63.2%** |
| enriched | 38 | 29 | 8 | 1 | 0 | **76.3%** |
...
|---|--:|--:|--:|--:|--:|--:|
| newly entered (enriched) | 63 | 49 | 12 | 1 | 1 | **77.8%** |
...
**The 9 discordant observations come from only 4 distinct questions:**
...
| `ref_comp_08` | comparative | 1 | 5 | text_only | chunk500_hybrid |
...
|---|--:|--:|--:|--:|--:|--:|
| pooled | 13 | 2 | 2 | 9 | 4 | 1.0000 |
| factual | 6 | 0 | 0 | 6 | 0 | n/a |
| thematic | 3 | 1 | 0 | 2 | 1 | 1.0000 |
| comparative | 4 | 1 | 2 | 1 | 3 | 1.0000 |

### 5.3 What the two tests jointly support

The observation-level test gives p=0.1797 pooled; the question-level test gives
